...
- `03_Concepts_Explained.md`
  Plain-English explanation of the main concepts used in the project, including API, frontend/backend separation, warehouse modeling, CSV processing, Spring Boot, DTOs, Postman, and deployment.
...
- API-first Spring Boot backend
- Separate standalone frontend dashboard
